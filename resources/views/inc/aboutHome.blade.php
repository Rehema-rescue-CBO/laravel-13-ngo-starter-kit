<style>
    .about-home-top {
        ...
        padding: 90px 0 0; /* Removed bottom padding */
    }
    ...
    .about-img-wrapper img {
        width: 100%;
        height: 100%; 
        object-fit: cover; /* Changed back to cover for a fuller look */
    ...
    .values-section {
        ...
        padding: 60px 0 90px; /* Reduced top padding */
    }
    ...
    @media (max-width: 767.98px) {
        ...
        .about-home-top {
            padding-bottom: 0; /* Keep sections connected on mobile */
        }

        .about-text-card h2 {
            font-size: 2.25rem; /* Slightly smaller heading on mobile */
        }

        .value-card-modern,
        .stat-box-modern {
            padding: 30px; /* Reduce padding inside cards on mobile */
        }
    }
</style>
...
<div class="container-fluid about-home-top">
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <!-- Right Side: Content (appears second on mobile) -->
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="about-text-card text-center text-lg-start">
                    ...
                    <p class="fs-5 text-muted mb-0" style="line-height: 1.8; font-weight: 400;">
                    ...
                    <a class="btn btn-primary rounded-pill py-3 px-5 mt-4" href="{{ route('about') }}">Learn More <i class="fa fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
    </div>
